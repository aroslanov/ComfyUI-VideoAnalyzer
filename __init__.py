...
class VideoAnalyzerExtension(ComfyExtension):
    ...
    async def get_node_list(self) -> list[type[io.ComfyNode]]:
        return [H3VLMModelLoader, MiniMaxH3VideoToPrompt, ShowH3Prompt]
